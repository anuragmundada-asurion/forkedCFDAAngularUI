...
describe("Unit Tests for Programs Service", function () {
    ...
    describe("Testing for list of Programs retrieval", function() {
        xit('should make a get call to retrieve list of programs', function() {
            $httpBackend
                .whenGET('/v1/program')
                .respond('{"queryList": {"results":[{"id": "e42b83cefdf94ff99c9677adb708", "data":{"_id": "e42b83cefdf94ff99c9677adb708", "title": "0000000000000Some title011111111111111111", "organizationId": "REI Test Agency", "projects": {"flag": "yes"}, "relatedTo": [], "projectsArray": []}},{"id":"6bb682cde63b48ae9c3fe448ac32", "data":{"_id": "6bb682cde63b48ae9c3fe448ac32", "title": "0000000000000Some title3", "organizationId": "REI Test Agency", "projects": {"flag": "yes"}, "relatedTo": [], "application": {"deadlines": {"approval": {"interval": "1"}}}, "projectsArray": []}}],"totalCount":0,"offset":0,"limit":2}}');
        ...
        xit('should populate _id field for all programs missing it', function() {
            $httpBackend
                .whenGET('/v1/program')
                .respond('{"queryList": {"results":[{"id": "e42b83cefdf94ff99c9677adb708", "data":{"_id": "e42b83cefdf94ff99c9677adb708", "title": "0000000000000Some title011111111111111111", "organizationId": "REI Test Agency", "projects": {"flag": "yes"}, "relatedTo": [], "projectsArray": []}},{"id":"6bb682cde63b48ae9c3fe448ac32", "data":{"_id":"6bb682cde63b48ae9c3fe448ac32", "title": "0000000000000Some title3", "organizationId": "REI Test Agency", "projects": {"flag": "yes"}, "relatedTo": [], "application": {"deadlines": {"approval": {"interval": "1"}}}, "projectsArray": []}}],"totalCount":0,"offset":0,"limit":2}}');
            var programs = programsSvc.query();
            $httpBackend.flush();
            angular.forEach(programs.queryList, function (program) {
